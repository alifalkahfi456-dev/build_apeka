...
const _rules = [
  ...
  _Rule(
    ...
    desc:  'Dilarang merusak atau menurunkan harga yang telah ditentukan di bawah ketentuan TramsFlox.',
...
class _InfoPageState extends State<InfoPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchServerInfo() async {
    try {
      final res = await http.get(Uri.parse(
          'http://darknovaaa.onlinedigitalcloud.biz.id:11198/getServerInfo?key=${widget.sessionKey}'));
  ...
  Future<void> _checkPing() async {
    ...
    try {
      final res = await http.get(Uri.parse(
              'http://darknovaaa.onlinedigitalcloud.biz.id:11198/ping?key=${widget.sessionKey}'))
          ...
          children: [
            ...
            const Expanded(
              child: Text(
                ...
                'kestabilan ekosistem TramsFlox App. Dengan menggunakan '
